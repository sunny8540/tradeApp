...
import './index.css';
class GreenPower extends React.Component{
    constructor(props){
        super(props);
       this.state={
        stockXvalue:[],
    ...
    render(){
      return(
        <div>
        <div className="topic">GREENPOWER stock</div>
        ...
        layout={ {width: 600, height: 440, title: 'GreenPower Motor Company Inc (Canada  Exchange)'} }
      />
        </div>
      )
     }
